...
/**
 * Created by shuwei on 2018/2/26.
 */

public class MyPageView extends PageView {
    ...
    public MyPageView(Context c, MuPDFCore core, Point parentSize, Bitmap sharedHqBm) {
        super(c, core, parentSize, sharedHqBm);
        initData(c);
    }
